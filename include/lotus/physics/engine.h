...
namespace lotus::physics {
	...
	public:
		...
		static bool handle_shape_particle_collision(const collision::shapes::plane&, const body_state&, cvec3d&);
		/// Handles the collision between a kinematic sphere and a particle.
		static bool handle_shape_particle_collision(const collision::shapes::sphere&, const body_state&, cvec3d&);
		/// Handles the collision between a kinematic polyhedron and a particle.
		static bool handle_shape_particle_collision(const collision::shapes::polyhedron&, const body_state&, cvec3d&);
