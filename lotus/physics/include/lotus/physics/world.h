...
namespace lotus::physics {
	...
	public:
		...
		struct rigid_body_collision {
			...
			rigid_body_collision(body &b1, body &b2, collision::rigid_body_contact i) :
				body1(&b1), body2(&b2), contact(i) {
			}

			body *body1; ///< The first body.
			body *body2; ///< The second body.
			collision::rigid_body_contact contact = uninitialized; ///< Information about the collision.
		};
