/// \file
/// A wrapper for including shader types. Include this file before and after including shader files. Note that this
/// file does not has an include guard in order to support multiple different includes.

#include "shader_types_impl.h"

#ifndef LOTUS_SHADER_TYPES_INCLUDE_WRAPPER_FIRST_PART_DONE
...
#	define LOTUS_SHADER_TYPES_INCLUDE_WRAPPER_FIRST_PART_DONE
...
#	undef LOTUS_SHADER_TYPES_INCLUDE_WRAPPER_FIRST_PART_DONE
